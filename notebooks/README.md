...
This should allow you to directly import `src/symmetricflow` in your notebook.
...
Run `python -m ipykernel install --user --name="symmetricflow"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called symmetricflow should be available in the
